...
const UserProfile = () => {
  ...
  const handleSave = async () => {
    ...
    if (editInfo.email && !isValidEmail(editInfo.email)) errors.push('El email no es válido');
    ...
    if (editInfo.newPassword) {
      ...
      if (editInfo.newPassword.length < 8) errors.push('La contraseña debe tener al menos 8 caracteres');
                ...
                <div className="pt-4 border-t border-white/10 mt-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input type={showPassword ? 'text' : 'password'} name="confirmPassword" placeholder="Repite la nueva contrase�a" className="premium-input" value={editInfo.confirmPassword} onChange={handleChange} />
                    </div>
                  </div>
                </div>
