...
class ChatService {
        ...
        try {
            ...
            this.ws.onmessage = (event) => {
                try {
                    ...
                    logger.error('Error al parsear mensaje WebSocket', error, { 
            ...
            this.ws.onerror = (error) => {
                logger.error('Error en WebSocket', error, { operation: 'websocket_error' });
                this.isConnecting = false;
            };
        } catch (error) {
            logger.error('Error al crear la instancia de WebSocket', error, { 
    ...
    sendTypingIndicator(receiverEmail, isTyping) {
        ...
        try {
            ...
            logger.error('Error al enviar indicador de escritura', error, { 
    ...
    sendReadReceipt(senderEmail) {
        ...
        try {
            ...
            logger.error('Error al enviar confirmación de lectura', error, { 
    ...
    async getChatRooms() {
        try {
            ...
            logger.error('Error al obtener salas de chat', error, { operation: 'getChatRooms' });
            throw error;
        }
    }
    ...
    async getUsers() {
        try {
            ...
            logger.error('Error al obtener usuarios', error, { operation: 'getUsers' });
            throw error;
        }
    }
    ...
    async getUnreadCount() {
        try {
            ...
            logger.error('Error al obtener conteo de mensajes no leídos', error, { 
